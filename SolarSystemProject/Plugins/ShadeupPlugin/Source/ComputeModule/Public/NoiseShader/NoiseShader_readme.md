...
// 1. Private/NoiseShader/NoiseShader.cpp under BEGIN_SHADER_PARAMETER_STRUCT
// 2. Public/NoiseShader/NoiseShader.h under FNoiseShaderDispatchParams
// 3. Private/NoiseShader/NoiseShader.cpp under FNoiseShaderInterface::DispatchRenderThread

// Executes the compute shader and blocks until complete. You can place outputs in the params struct
FNoiseShaderInterface::Dispatch(Params);
```
