...
// 1. Private/CraterShader/CraterShader.cpp under BEGIN_SHADER_PARAMETER_STRUCT
// 2. Public/CraterShader/CraterShader.h under FCraterShaderDispatchParams
// 3. Private/CraterShader/CraterShader.cpp under FCraterShaderInterface::DispatchRenderThread

// Executes the compute shader and blocks until complete. You can place outputs in the params struct
FCraterShaderInterface::Dispatch(Params);
```
